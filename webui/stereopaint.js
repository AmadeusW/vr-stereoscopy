...
AFRAME.registerComponent("stereopaint", {
    ...
    update: function() {
        console.log("update");
        dynamic = new Image();
        //dynamic.crossOrigin = "anonymous"; // prevent "Tainted canvases may not be loaded."
        dynamic.src = this.data.url;
        dynamic.onload = this.draw.render(); //tell it to update the texture
